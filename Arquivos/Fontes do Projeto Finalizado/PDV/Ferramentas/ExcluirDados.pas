...
begin
 ...
 if excluir = 'Vendas' then
    begin
          ...
          if MessageDlg('Deseja Excluir as Vendas entre as datas de ' + DateToStr(dataInicial.Date) + ' à ' + DateToStr(dataFinal.Date) + ' ?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
            begin
          ...
          MessageDlg('Deletado com Sucesso!!', mtInformation, mbOKCancel, 0);
           ...
           if excluir = 'Caixa' then
              ...
              if MessageDlg('Deseja Excluir os Registros do Caixa entre as datas de ' + DateToStr(dataInicial.Date) + ' à ' + DateToStr(dataFinal.Date) + ' ?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
                begin
           ...
           if MessageDlg('Deseja Excluir os Registros de Movimentações entre as datas de ' + DateToStr(dataInicial.Date) + ' à ' + DateToStr(dataFinal.Date) + ' ?', mtConfirmation, [mbYes, mbNo], 0) = mrYes then
            begin
                begin
                  dm.query_mov.Close;
